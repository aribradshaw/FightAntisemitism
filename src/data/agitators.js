...
export const AGITATORS = [
  ...
  },
  {
    ...
    sources: [
      ...
      { date: 'Ongoing', text: 'Streams and rallies promoting antisemitic and white nationalist ideology.', url: '#' },
    ],
  },
  {
    slug: 'ilhan-omar',
  ...
  },
  {
    ...
    sources: [
      ...
      { date: '2023', text: 'Remarks that critics say minimize the significance of Holocaust education and antisemitism.', url: '#' },
    ],
  },
  {
    ...
    sources: [
      ...
      { date: '2021–present', text: 'Holocaust comparisons (masks, vaccines) and Soros tropes.', url: '#' },
    ],
  },
  {
    slug: 'greta-thunberg',
    ...
    sources: [
      ...
      { date: '2024', text: 'Continued rhetoric that critics say demonizes Israel and blurs Jews with Israeli policy.', url: '#' },
    ],
  },
  {
    slug: 'cenk-uygur',
